...
import { test, expect, countTimes } from './copilotbrowser-test-fixtures';
  ...
  const result = await runInlineTest({
    'copilotbrowser.config.js': `
      module.exports = {
        ...
        // See: https://github.com/dayour/copilotbrowser/issues/24157
        outputDir: 'Привет',
        use: {
          connectOptions: {
          ...
          launchOptions: {
            env: {
              // Customers can have special characters: https://github.com/dayour/copilotbrowser/issues/24157
    ...
    'global-setup.ts': `
      ...
      module.exports = async () => {
        process.env.DEBUG = 'cb:browser';
        process.env.CBTEST_SERVER_WS_HEADERS =
          'x-copilotbrowser-debug-log: a-debug-log-string\\r\\n' +
          'x-copilotbrowser-attachment: attachment-a=value-a\\r\\n' +
          'x-copilotbrowser-debug-log: b-debug-log-string\\r\\n' +
          'x-copilotbrowser-attachment: attachment-b=value-b';
