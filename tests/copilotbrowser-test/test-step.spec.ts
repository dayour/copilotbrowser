...
import { test, expect, stripAnsi } from './copilotbrowser-test-fixtures';

const stepIndentReporter = `
import { FullConfig, Location, Reporter, Suite, TestStep } from '@copilotbrowser/copilotbrowser/reporter';
...
cb:api    |    Launch browser
fixture   |  Fixture "context"
cb:api    |    Create context
...
test('should report custom expect steps', async ({ runInlineTest }) => {
  const result = await runInlineTest({
    ...
    `,
    'a.test.ts': `
      import { test, expect as baseExpect } from '@copilotbrowser/copilotbrowser/test';
...
test('step timeout is errors.TimeoutError', async ({ runInlineTest }) => {
  const result = await runInlineTest({
    'a.test.ts': `
      import { test, expect, errors } from '@copilotbrowser/copilotbrowser/test';
...
cb:api    |      Click locator('body') @ a.test.ts:24
...
fixture   |    Fixture "browser"
cb:api    |      Launch browser
cb:api    |    Create page @ a.test.ts:6
cb:api    |Set content @ a.test.ts:15
cb:api    |Click locator('div') @ a.test.ts:16
cb:api    |↪ error: Error: page.click: Target page, context or browser has been closed
hook      |After Hooks
hook      |  afterAll hook @ a.test.ts:9
cb:api    |    Close context @ a.test.ts:10
hook      |Worker Cleanup
fixture   |  Fixture "browser"
          |Test timeout of 2000ms exceeded.
...
test('should not propagate errors from within toPass', async ({ runInlineTest }) => {
  const result = await runInlineTest({
    'reporter.ts': stepIndentReporter,
    'copilotbrowser.config.ts': `module.exports = { reporter: './reporter', };`,
    'a.test.ts': `
      import { test, expect } from '@copilotbrowser/copilotbrowser/test';
      test('pass', async () => {
        let i = 0;
...
test('should step w/o box', async ({ runInlineTest }) => {
  const result = await runInlineTest({
    'reporter.ts': stepIndentReporter,
    'copilotbrowser.config.ts': `module.exports = { reporter: [['./reporter', { printErrorLocation: true }]], };`,
    'a.test.ts':
    ` /*1*/ import { test, expect } from '@copilotbrowser/copilotbrowser/test';
      /*2*/ test('fail', async () => {
...
fixture   |  Fixture "page"
cb:api    |    Create page
cb:api    |Set content @ a.test.ts:4
...
test('step inside toPass', async ({ runInlineTest }) => {
  test.info().annotations.push({ type: 'issue', description: 'https://github.com/dayour/copilotbrowser/issues/30322' });
  const result = await runInlineTest({
    'reporter.ts': stepIndentReporter,
    'copilotbrowser.config.ts': `
      module.exports = {
...
cb:api    |    Create page
expect    |Expect "toPass" @ a.test.ts:11
cb:api    |  Navigate to "about:blank" @ a.test.ts:6
...
cb:api    |  Navigate to "about:blank" @ a.test.ts:7
...
test('should report api steps', async ({ runInlineTest, server }) => {
  ...
  const result = await runInlineTest({
    'reporter.ts': stepIndentReporter,
    'copilotbrowser.config.ts': `module.exports = { reporter: [['./reporter', { skipErrorMessage: true }]] };`,
    'a.test.ts': `
      import { test, expect } from '@copilotbrowser/copilotbrowser/test';
...
cb:api    |    Create page @ a.test.ts:17
cb:api    |    Set content @ a.test.ts:18
cb:api    |Click locator('button') @ a.test.ts:22
hook      |After Hooks
hook      |Before Hooks
cb:api    |Click locator('button') @ a.test.ts:25
hook      |After Hooks
hook      |Before Hooks
cb:api    |Fill "foo" getByRole('textbox') @ a.test.ts:28
cb:api    |Fill "" getByRole('textbox') @ a.test.ts:29
cb:api    |Clear getByRole('textbox') @ a.test.ts:30
hook      |After Hooks
hook      |  afterAll hook @ a.test.ts:33
cb:api    |    Close context @ a.test.ts:34
hook      |Before Hooks
fixture   |  Fixture "browser"
cb:api    |    Launch browser
fixture   |  Fixture "context"
...
cb:api    |    Create request context
cb:api    |Wait for navigation @ a.test.ts:5
cb:api    |Navigate to "data:" @ a.test.ts:6
cb:api    |Click locator('button') @ a.test.ts:8
cb:api    |Click getByRole('button') @ a.test.ts:9
cb:api    |GET "/empty.html" @ a.test.ts:10
cb:api    |↪ error: <error message>
cb:api    |GET "/empty.html" @ a.test.ts:11
cb:api    |↪ error: <error message>
hook      |After Hooks
fixture   |  Fixture "request"
fixture   |  Fixture "page"
...
cb:api    |    Create page
cb:api    |Set content @ a.test.ts:4
cb:api    |Click locator('input') @ a.test.ts:5
cb:api    |↪ error: TimeoutError: page.click: Timeout 1ms exceeded.
hook      |After Hooks
fixture   |  Fixture "page"
fixture   |  Fixture "context"
cb:api    |    Close context
...
cb:api    |    Create page
cb:api    |Set content @ a.test.ts:4
cb:api    |Evaluate locator('button') @ a.test.ts:6
hook      |After Hooks
fixture   |  Fixture "page"
fixture   |  Fixture "context"
cb:api    |    Close context
...
test('should allow passing location to test.step', async ({ runInlineTest, runTSC }) => {
  const result = await runInlineTest({
    'reporter.ts': stepIndentReporter,
    'helper.ts': `
      import { Location, TestType } from '@copilotbrowser/copilotbrowser/test';
...
cb:api    |    Trace "my group 1" @ a.test.ts:6
cb:api    |      Trace "my group 2" @ a.test.ts:7
cb:api    |        Set content @ a.test.ts:8
hook      |After Hooks
fixture   |  Fixture "page"
fixture   |  Fixture "context"
cb:api    |    Close context
...
test('calls from waitForEvent callback should be under its parent step', {
  annotation: { type: 'issue', description: 'https://github.com/dayour/copilotbrowser/issues/33186' }
...
fixture   |  Fixture "page"
cb:api    |    Create page
cb:api    |Navigate to "/empty.html" @ a.test.ts:4
cb:api    |Set content @ a.test.ts:5
test.step |custom step @ a.test.ts:6
cb:api    |  Wait for event "response" @ a.test.ts:7
cb:api    |  Click locator('div') @ a.test.ts:14
cb:api    |  Get content @ a.test.ts:8
cb:api    |  Get content @ a.test.ts:9
...
test('reading network request / response should not be listed as step', {
  annotation: { type: 'issue', description: 'https://github.com/dayour/copilotbrowser/issues/33558' }
}, async ({ runInlineTest, server }) => {
  const result = await runInlineTest({
    'reporter.ts': stepIndentReporter,
    'copilotbrowser.config.ts': `module.exports = { reporter: './reporter' };`,
...
fixture   |  Fixture "page"
cb:api    |    Create page
cb:api    |Wait for event "request" @ a.test.ts:5
cb:api    |Wait for event "response" @ a.test.ts:6
cb:api    |Navigate to "/empty.html" @ a.test.ts:7
hook      |After Hooks
fixture   |  Fixture "page"
fixture   |  Fixture "context"
cb:api    |    Close context
...
cb:api    |  Navigate to "/empty.html" @ a.test.ts:12
cb:api    |  GET "/empty.html" @ a.test.ts:6
...
test('step.titlePath works in custom matcher', { annotation: { type: 'issue', description: 'https://github.com/dayour/copilotbrowser/issues/36739' } }, async ({ runInlineTest }) => {
  const result = await runInlineTest({
    'a.test.ts': `
      import { test, expect as baseExpect } from '@copilotbrowser/copilotbrowser/test';
      const expect = baseExpect.extend({
...
fixture   |  Fixture "page"
cb:api    |    Create page
cb:api    |Set content @ a.test.ts:16
expect    |Expect "toBeInvisible" locator('div') @ a.test.ts:17
expect    |  Expect "poll toBe" @ a.test.ts:7
cb:api    |    Query count locator('div').filter({ visible: true }) @ a.test.ts:7
expect    |    Expect "toBe" @ a.test.ts:7
expect    |    ↪ error: Error: expect(received).toBe(expected) // Object.is equality
cb:api    |    Query count locator('div').filter({ visible: true }) @ a.test.ts:7
expect    |    Expect "toBe" @ a.test.ts:7
...
cb:api    |    Query count locator('div').filter({ visible: true }) @ a.test.ts:7
expect    |    Expect "toBe" @ a.test.ts:7
cb:api    |Wait for timeout @ a.test.ts:18
cb:api    |Set content @ a.test.ts:19
hook      |After Hooks
fixture   |  Fixture "page"
fixture   |  Fixture "context"
cb:api    |    Close context
...
test('should box fixtures', async ({ runInlineTest }) => {
  const result = await runInlineTest({
    ...
    'copilotbrowser.config.ts': `module.exports = { reporter: './reporter' };`,
    'a.test.ts': `
      import { test as baseTest, expect, type Page } from '@copilotbrowser/copilotbrowser/test';
...
cb:api    |    Set content @ a.test.ts:14
test.step |    inner step @ a.test.ts:15
cb:api    |      Navigate to "data:" @ a.test.ts:16
cb:api    |  Set content @ a.test.ts:22
test.step |  inner step @ a.test.ts:23
cb:api    |    Navigate to "data:" @ a.test.ts:24
...
hook      |After Hooks
cb:api    |  Set content @ a.test.ts:27
fixture   |  Fixture "bar" @ a.test.ts:4
cb:api    |    Set content @ a.test.ts:19
fixture   |  Fixture "page"
fixture   |  Fixture "context"
