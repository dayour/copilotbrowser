...
import { cleanEnv, cliEntrypoint, test as base, writeFiles, removeFolders } from './copilotbrowser-test-fixtures';
        ...
        await use(async (files: Files, env: NodeJS.ProcessEnv = {}, options: UIModeOptions = {}) => {
          ...
          testProcess = childProcess({
            ...
            env: {
              ...cleanEnv(env),
              CBTEST_UNDER_TEST: '1',
              CBTEST_CACHE_DIR: cacheDir,
              CBTEST_HEADED_FOR_TEST: headless ? '0' : '1',
              CBTEST_PRINT_WS_ENDPOINT: '1',
            },
