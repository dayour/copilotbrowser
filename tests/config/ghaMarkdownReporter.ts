...
import MarkdownReporter from '../../packages/copilotbrowser/src/reporters/markdown';

import type { MetadataWithCommitInfo } from 'copilotbrowser/src/isomorphic/types';
...
class GHAMarkdownReporter extends MarkdownReporter {
  ...
  private _magicComment() {
    return `<!-- Generated by copilotbrowser markdown reporter for ${this._workflowRunName()} in job ${process.env.GITHUB_JOB} -->`;
  }
