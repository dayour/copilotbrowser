...
export class RunServer implements copilotbrowserServer {
...
export class RemoteServer implements copilotbrowserServer {
  private _process!: TestChildProcess;
  ...
  async _start(childProcess: CommonFixtures['childProcess'], browserType: BrowserType, channel: string, remoteServerOptions: RemoteServerOptions = {}) {
    ...
    const browserOptions = (browserType as any)._copilotbrowser._defaultLaunchOptions;
