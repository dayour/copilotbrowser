...
test('should check types of fixtures', async ({ runTSC }) => {
  const result = await runTSC({
    'helper.ts': `
      import { test as base, expect, Page } from '@copilotbrowser/test';
    ...
    'copilotbrowser.config.ts': `
      ...
      import { Config } from '@copilotbrowser/test';
    ...
    'copilotbrowser-props.config.ts': `
      import { copilotbrowserTestConfig } from '@copilotbrowser/test';
