...
test('should batch watch updates', async ({ runUITest, writeFiles }) => {
  const { page } = await runUITest({
    'a.test.ts': `import { test } from '@copilotbrowser/test'; test('test', () => {});`,
    'b.test.ts': `import { test } from '@copilotbrowser/test'; test('test', () => {});`,
    'c.test.ts': `import { test } from '@copilotbrowser/test'; test('test', () => {});`,
    'd.test.ts': `import { test } from '@copilotbrowser/test'; test('test', () => {});`,
  });
...
test('should queue watches', async ({ runUITest, writeFiles, createLatch }) => {
  ...
  const { page } = await runUITest({
    'a.test.ts': `import { test } from '@copilotbrowser/test'; test('test', () => {});`,
    'b.test.ts': `import { test } from '@copilotbrowser/test'; test('test', async () => {
      ${latch.blockingCode}
    });`,
    'c.test.ts': `import { test } from '@copilotbrowser/test'; test('test', () => {});`,
    'd.test.ts': `import { test } from '@copilotbrowser/test'; test('test', () => {});`,
