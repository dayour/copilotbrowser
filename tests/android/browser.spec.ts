...
test('should take page screenshot', async function({ androidDevice }) {
  test.info().annotations.push({ type: 'issue', description: 'https://github.com/dayour/copilotbrowser/issues/26342' });
...
test('should record har', async ({ androidDevice }) => {
  test.info().annotations.push({ type: 'issue', description: 'https://github.com/dayour/copilotbrowser/issues/28015' });
