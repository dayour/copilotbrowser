...
// See https://github.com/dayour/copilotbrowser/pull/37103.
...
test('should highlight inside iframe', async ({ backend, connectedBrowser }, testInfo) => {
  testInfo.annotations.push({ type: 'issue', description: 'https://github.com/dayour/copilotbrowser/issues/33146' });
