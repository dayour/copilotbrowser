...
import type { Page, BrowserContext, Cookie } from 'copilotbrowser';
...
test('should be able to send third party cookies via an iframe', async ({ browser, httpsServer, browserName, isMac, isBidi }) => {
  ...
  test.info().annotations.push({ type: 'issue', description: 'https://github.com/dayour/copilotbrowser/issues/16937' });
