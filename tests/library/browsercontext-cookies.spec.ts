...
it('should allow adding cookies with >400 days expiration', {
  annotation: { type: 'issue', description: 'https://github.com/dayour/copilotbrowser/issues/37903' }
...
it('should support requestStorageAccess', async ({ page, server, channel, browserName, isMac, isLinux, isWindows, macVersion }) => {
  it.info().annotations.push({ type: 'issue', description: 'https://github.com/dayour/copilotbrowser/issues/17285' });
...
it('should parse cookie with large Max-Age correctly', async ({ server, page, defaultSameSiteCookieValue, browserName, platform }) => {
  it.info().annotations.push({ type: 'issue', description: 'https://github.com/dayour/copilotbrowser/issues/30305' });
...
it('iframe should inherit cookies from parent', { annotation: { type: 'issue', description: 'https://github.com/dayour/copilotbrowser/issues/35439' } }, async ({ page, isLinux, browserName }) => {
