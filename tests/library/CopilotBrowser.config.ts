...
import { type Config, type copilotbrowserTestOptions, type copilotbrowserWorkerOptions, type ReporterDescription } from '@copilotbrowser/test';
...
if (channel === 'webkit-wsl') {
  ...
  webServer = {
    command: 'set PWTEST_UNDER_TEST=1 && set WSLENV=PWTEST_UNDER_TEST && wsl.exe -d copilotbrowser -u pwuser -- bash -lc \'/home/pwuser/node/bin/npx copilotbrowser run-server --port=3777\'',
