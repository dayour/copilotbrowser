...
import { deviceDescriptors } from 'packages/copilotbrowser-core/lib/server/deviceDescriptors';
...
it('should set window.screen.orientation.type for mobile devices', async ({ contextFactory, browserName, server, isBidi }) => {
  it.info().annotations.push({ type: 'issue', description: 'https://github.com/dayour/copilotbrowser/issues/31151' });
