...
import { copilotbrowserTest, expect } from '../config/browserTest';
...
const it = copilotbrowserTest.extend<{}, { expectScopeState: (object: any, golden: any) => void }>({
