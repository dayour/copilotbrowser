...
it('should set cookie for top-level domain', {
  annotation: { type: 'issue', description: 'https://github.com/dayour/copilotbrowser/issues/18362' }
...
it('should isolate proxy credentials between contexts on navigation', async ({ contextFactory, server }) => {
  it.info().annotations.push({ type: 'issue', description: 'https://github.com/dayour/copilotbrowser/issues/31525' });
