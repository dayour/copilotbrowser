...
it('should not stall on evaluate when dismissing beforeunload', async ({ page, server }) => {
  it.info().annotations.push({ type: 'issue', description: 'https://github.com/dayour/copilotbrowser/issues/23141' });
...
it('should not stall on click when dismissing beforeunload', async ({ page, server }) => {
  it.info().annotations.push({ type: 'issue', description: 'https://github.com/dayour/copilotbrowser/issues/33806' });
...
it('does not get stalled by beforeUnload', {
  annotation: { type: 'issue', description: 'https://github.com/dayour/copilotbrowser/issues/38731' },
}, async ({ page, server }) => {
