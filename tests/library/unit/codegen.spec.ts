...
test.describe('javascript', () => {
  ...
  test('generatecopilotbrowserRequestCall', () => {

    expect(impl.generatecopilotbrowserRequestCall({
...
await page.request.fetch('http://example.com/foo', {
  ...
  test('generatecopilotbrowserRequestCall with POST method and no body', () => {
    expect(impl.generatecopilotbrowserRequestCall({
...
await page.request.post('http://example.com/foo', {
  ...
  test('generatecopilotbrowserRequestCall with PUT method and JSON body', () => {
    expect(impl.generatecopilotbrowserRequestCall({
      url: 'http://example.com/foo',
      method: 'PUT',
      headers: [{ name: 'Content-Type', value: 'application/json' }],
...
await page.request.put('http://example.com/foo', {
  ...
  test('generatecopilotbrowserRequestCall with PATCH method and form data', () => {
    expect(impl.generatecopilotbrowserRequestCall({
      url: 'http://example.com/foo',
      method: 'PATCH',
...
await page.request.patch('http://example.com/foo', {
  ...
  test('generatecopilotbrowserRequestCall with DELETE method and custom header', () => {
    expect(impl.generatecopilotbrowserRequestCall({
      url: 'http://example.com/foo',
      method: 'DELETE',
...
await page.request.delete('http://example.com/foo', {
  ...
  test('generatecopilotbrowserRequestCall with HEAD method', () => {
    expect(impl.generatecopilotbrowserRequestCall({
      url: 'http://example.com/foo',
      method: 'HEAD',
      headers: [],
...
await page.request.head('http://example.com/foo');`.trim());
  ...
  test('generatecopilotbrowserRequestCall with complex query parameters', () => {
    expect(impl.generatecopilotbrowserRequestCall({
...
await page.request.get('http://example.com/foo', {
  ...
  test('generatecopilotbrowserRequestCall with multiple headers', () => {
    expect(impl.generatecopilotbrowserRequestCall({
      url: 'http://example.com/foo',
      method: 'GET',
      headers: [
