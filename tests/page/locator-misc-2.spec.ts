...
it('locator.count should work with deleted Map in main world', async ({ page }) => {
  it.info().annotations.push({ type: 'issue', description: 'https://github.com/dayour/copilotbrowser/issues/11254' });
...
it('should fill programmatically enabled textarea', { annotation: { type: 'issue', description: 'https://github.com/dayour/copilotbrowser/issues/36307' } }, async ({ page }) => {
  await page.setContent(`
...
it('press should throw on unknown keys', { annotation: { type: 'issue', description: 'https://github.com/dayour/copilotbrowser/issues/36697' } }, async ({ page, server }) => {
