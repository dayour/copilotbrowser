...
it('tab should cycle between single input and browser', {
  annotation: { type: 'issue', description: 'https://github.com/dayour/copilotbrowser/issues/32339' }
...
it('keeps focus on element when attempting to focus a non-focusable element', async ({ page }) => {
  it.info().annotations.push({ type: 'issue', description: 'https://github.com/dayour/copilotbrowser/issues/14254' });
