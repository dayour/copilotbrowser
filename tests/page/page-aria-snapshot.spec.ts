...
it('should not show visible children of hidden elements', { annotation: { type: 'issue', description: 'https://github.com/dayour/copilotbrowser/issues/36296' }  }, async ({ page }) => {
  await page.setContent(`
...
it('should not show unhidden children of aria-hidden elements', { annotation: { type: 'issue', description: 'https://github.com/dayour/copilotbrowser/issues/36296' }  }, async ({ page }) => {
  await page.setContent(`
