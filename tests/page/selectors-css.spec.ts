...
it('should work with :scope and class', async ({ page }) => {
  it.info().annotations.push({ type: 'issue', description: 'https://github.com/dayour/copilotbrowser/issues/17824' });
...
it('should use light DOM structure for child combinator with slotted content', { annotation: { type: 'issue', description: 'https://github.com/dayour/copilotbrowser/issues/37768' } }, async ({ page }) => {
  await page.setContent(`
    <my-button>
