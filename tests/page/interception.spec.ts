...
it('should work with glob', async () => {
  ...
  expect(urlMatches(undefined, 'http://copilotbrowser.dev/', 'http://copilotbrowser.dev')).toBeTruthy();
  expect(urlMatches(undefined, 'http://copilotbrowser.dev/?a=b', 'http://copilotbrowser.dev?a=b')).toBeTruthy();
  expect(urlMatches(undefined, 'http://copilotbrowser.dev/', 'h*://copilotbrowser.dev')).toBeTruthy();
  expect(urlMatches(undefined, 'http://api.copilotbrowser.dev/?x=y', 'http://*.copilotbrowser.dev?x=y')).toBeTruthy();
  expect(urlMatches(undefined, 'http://copilotbrowser.dev/foo/bar', '**/foo/**')).toBeTruthy();
  expect(urlMatches('http://copilotbrowser.dev', 'http://copilotbrowser.dev/?x=y', '?x=y')).toBeTruthy();
  expect(urlMatches('http://copilotbrowser.dev/foo/', 'http://copilotbrowser.dev/foo/bar?x=y', './bar?x=y')).toBeTruthy();

  // Case insensitive matching
  expect(urlMatches(undefined, 'https://dayour.github.io/copilotbrowser/fooBAR', 'https://dayour.github.io/copilotbrowser/fooBAR')).toBeTruthy();
  expect(urlMatches('http://ignored', 'https://dayour.github.io/copilotbrowser/fooBAR', 'https://dayour.github.io/copilotbrowser/fooBAR')).toBeTruthy();
  // Path and search query are case-sensitive
  expect(urlMatches(undefined, 'https://dayour.github.io/copilotbrowser/foobar', 'https://dayour.github.io/copilotbrowser/fooBAR')).toBeFalsy();
  expect(urlMatches(undefined, 'https://dayour.github.io/copilotbrowser/foobar?a=b', 'https://dayour.github.io/copilotbrowser/foobar?A=B')).toBeFalsy();
  ...
  expect(urlMatches(undefined, 'http://copilotbrowser.dev/', 'http://copilotbrowser.?ev')).toBeFalsy();
  expect(urlMatches(undefined, 'http://copilotbrowser./?ev', 'http://copilotbrowser.?ev')).toBeTruthy();
  expect(urlMatches(undefined, 'http://copilotbrowser.dev/foo', 'http://copilotbrowser.dev/f??')).toBeFalsy();
  expect(urlMatches(undefined, 'http://copilotbrowser.dev/f??', 'http://copilotbrowser.dev/f??')).toBeTruthy();
  expect(urlMatches(undefined, 'http://copilotbrowser.dev/?x=y', 'http://copilotbrowser.dev\\?x=y')).toBeTruthy();
  expect(urlMatches(undefined, 'http://copilotbrowser.dev/?x=y', 'http://copilotbrowser.dev/\\?x=y')).toBeTruthy();
  expect(urlMatches('http://copilotbrowser.dev/foo', 'http://copilotbrowser.dev/foo?bar', '?bar')).toBeTruthy();
  expect(urlMatches('http://copilotbrowser.dev/foo', 'http://copilotbrowser.dev/foo?bar', '\\\\?bar')).toBeTruthy();
  expect(urlMatches('http://first.host/', 'http://second.host/foo', '**/foo')).toBeTruthy();
  expect(urlMatches('http://copilotbrowser.dev/', 'http://localhost/', '*//localhost/')).toBeTruthy();
  ...
  for (const prefix of customPrefixes) {
    expect(urlMatches('http://copilotbrowser.dev/', `${prefix}:blank`, `${prefix}:blank`)).toBeTruthy();
    expect(urlMatches('http://copilotbrowser.dev/', `${prefix}:blank`, `http://copilotbrowser.dev/`)).toBeFalsy();
...
it('should intercept worker requests when enabled after worker creation', {
  annotation: { type: 'issue', description: 'https://github.com/dayour/copilotbrowser/issues/32355' }
...
it('should intercept network activity from worker 2', {
  annotation: { type: 'issue', description: 'https://github.com/dayour/copilotbrowser/issues/31747' }
