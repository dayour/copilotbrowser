...
it('text-is() should ignore comments', {
  annotation: { type: 'issue', description: 'https://github.com/dayour/copilotbrowser/issues/33976' }
}, async ({ page }) => {
...
it('should work with leading and trailing spaces', async ({ page }) => {
  it.info().annotations.push({ type: 'issue', description: 'https://github.com/dayour/copilotbrowser/issues/10997' });
...
it('should work with unpaired quotes when not at the start', async ({ page }) => {
  it.info().annotations.push({ type: 'issue', description: 'https://github.com/dayour/copilotbrowser/issues/12719' });
  await page.setContent(`
...
it('should work with paired quotes in the middle of selector', async ({ page }) => {
  it.info().annotations.push({ type: 'issue', description: 'https://github.com/dayour/copilotbrowser/issues/16858' });
