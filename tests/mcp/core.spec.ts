...
test('visibility: hidden > visible should be shown', { annotation: { type: 'issue', description: 'https://github.com/dayour/copilotbrowser-mcp/issues/535' } }, async ({ client, server }) => {
  server.setContent('/', `
