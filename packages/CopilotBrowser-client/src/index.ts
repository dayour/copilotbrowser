...
import { Connection } from '../../copilotbrowser-core/src/client/connection';
import { webPlatform } from './webPlatform';

import type { Browser } from '../../copilotbrowser-core/src/client/browser';
...
export async function connect(wsEndpoint: string, browserName: string, options: Options): Promise<Browser> {
  ...
  return copilotbrowser._preLaunchedBrowser();
}
