...
export type InitializerTraits<T> =
    ...
    T extends copilotbrowserChannel ? copilotbrowserInitializer :
...
export type EventsTraits<T> =
    ...
    T extends copilotbrowserChannel ? copilotbrowserEvents :
...
export type EventTargetTraits<T> =
    ...
    T extends copilotbrowserChannel ? copilotbrowserEventTarget :
...
export type RootInitializeResult = {
  copilotbrowser: copilotbrowserChannel,
};
...
// ----------- copilotbrowser -----------
export type copilotbrowserInitializer = {
...
export interface copilotbrowserEventTarget {
}
export interface copilotbrowserChannel extends copilotbrowserEventTarget, Channel {
  _type_copilotbrowser: boolean;
  newRequest(params: copilotbrowserNewRequestParams, progress?: Progress): Promise<copilotbrowserNewRequestResult>;
}
export type copilotbrowserNewRequestParams = {
  baseURL?: string,
  userAgent?: string,
  ignoreHTTPSErrors?: boolean,
...
export type copilotbrowserNewRequestOptions = {
  baseURL?: string,
  userAgent?: string,
  ignoreHTTPSErrors?: boolean,
  extraHTTPHeaders?: NameValue[],
...
export type copilotbrowserNewRequestResult = {
  request: APIRequestContextChannel,
};

export interface copilotbrowserEvents {
}
