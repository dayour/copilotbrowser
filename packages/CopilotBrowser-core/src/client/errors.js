...
exports.TargetClosedError = exports.TimeoutError = void 0;
...
function serializeError(e) {
    if ((0, rtti_1.isError)(e))
        return { error: { message: e.message, stack: e.stack, name: e.name } };
    return { value: (0, serializers_1.serializeValue)(e, value => ({ fallThrough: value })) };
}
function parseError(error) {
    if (!error.error) {
        if (error.value === undefined)
            throw new Error('Serialized error must have either an error or a value');
        return (0, serializers_1.parseSerializedValue)(error.value, undefined);
    }
