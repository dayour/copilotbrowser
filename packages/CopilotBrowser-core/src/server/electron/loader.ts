...
// Always pass user arguments first, see https://github.com/dayour/copilotbrowser/issues/16614 and
// https://github.com/dayour/copilotbrowser/issues/29198.
...
(globalThis as any).__copilotbrowser_run = async () => {
