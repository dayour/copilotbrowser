...
export class WKPage implements PageDelegate {
  ...
  handleProvisionalLoadFailed(event: Protocol.copilotbrowser.provisionalLoadFailedPayload) {
  ...
  handleWindowOpen(event: Protocol.copilotbrowser.windowOpenPayload) {
