...
class JavaLanguageGenerator {
    ...
    _asLocator(selector, inFrameLocator) {
        return (0, utils_1.asLocator)('java', selector, inFrameLocator);
    }
    ...
    public class Example {
      public static void main(String[] args) {
        try (copilotbrowser copilotbrowser = copilotbrowser.create()) {
          Browser browser = copilotbrowser.${options.browserName}().launch(${formatLaunchOptions(options.launchOptions)});
