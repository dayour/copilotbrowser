...
exports.CookieStore = exports.Cookie = void 0;
...
class Cookie {
    ...
    matches(url) {
        if (this._raw.secure && (url.protocol !== 'https:' && !(0, network_1.isLocalHostname)(url.hostname)))
            return false;
            ...
            case 'expires':
                ...
                if (isFinite(expiresMs)) {
                    if (expiresMs <= 0)
                        ...
                        cookie.expires = Math.min(expiresMs / 1000, network_1.kMaxCookieExpiresDateInSeconds);
                }
                break;
            case 'max-age':
                ...
                if (isFinite(maxAgeSec)) {
                    ...
                    if (maxAgeSec <= 0)
                        ...
                        cookie.expires = Math.min(Date.now() / 1000 + maxAgeSec, network_1.kMaxCookieExpiresDateInSeconds);
                }
                break;
            case 'domain':
