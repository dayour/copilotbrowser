...
class CDPSessionDispatcher extends dispatcher_1.Dispatcher {
    ...
    constructor(scope, cdpSession) {
        ...
        this.addObjectListener(crConnection_1.CDPSession.Events.Event, ({ method, params }) => this._dispatchEvent('event', { method, params }));
        this.addObjectListener(crConnection_1.CDPSession.Events.Closed, () => this._dispose());
    }
