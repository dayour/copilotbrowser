...
exports.setcopilotbrowserTestProcessEnv = setcopilotbrowserTestProcessEnv;
...
// Indicate that this and child processes are running under copilotbrowser Test.
function setcopilotbrowserTestProcessEnv() {
    return process.env['copilotbrowser_TEST'] = '1';
}
