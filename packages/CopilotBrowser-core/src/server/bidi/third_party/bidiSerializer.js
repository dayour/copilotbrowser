...
exports.isDate = exports.isRegExp = exports.isPlainObject = exports.BidiSerializer = void 0;
...
class BidiSerializer {
    ...
    static _serializeObject(arg) {
        ...
        else if ((0, exports.isPlainObject)(arg)) {
            try {
                JSON.stringify(arg);
            }
            catch (error) {
        ...
        else if ((0, exports.isRegExp)(arg)) {
            return {
                type: 'regexp',
                value: {
                    pattern: arg.source,
