...
export const WorkbenchLoader: React.FunctionComponent<{
  ...
  return <div className='vbox workbench-loader' onDragOver={event => {
    ...
    <div className='hbox header' {...(showFileUploadDropArea ? { inert: true } : {})}>
      <div className='logo'>
        <img src='copilotbrowser-logo.svg' alt='copilotbrowser logo' />
      </div>
      <div className='product'>copilotbrowser</div>
    ...
    {fileForLocalModeError && <div className='drop-target'>
      ...
      <div style={{ paddingTop: 20 }}>
        ...
        <div>2. Go to <a href='https://trace.copilotbrowser.dev'>trace.copilotbrowser.dev</a></div>
    ...
    <Dialog open={showProgressDialog} isModal={true} className='progress-dialog'>
      <div className='progress-content'>
        <div className='title' role='heading' aria-level={1}>Loading copilotbrowser Trace...</div>
    ...
    {showFileUploadDropArea && <div className='drop-target'>
      ...
      <div className='title' role='heading' aria-level={1}>Drop copilotbrowser Trace to load</div>
      <div>or</div>
      <button onClick={() => {
      ...
      <div className='info'>copilotbrowser Trace Viewer is a Progressive Web App, it does not send your trace anywhere,
        it opens it locally.</div>
      <div className='version'>copilotbrowser v{__APP_VERSION__}</div>
    </div>}
    ...
    {dragOver && <div className='drop-target'
      ...
      <div className='title'>Release to analyse the copilotbrowser Trace</div>
    </div>}
  </div>;
};
