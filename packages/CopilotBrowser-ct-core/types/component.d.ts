...
declare global {
  interface Window {
    copilotbrowserMount(component: Component, rootElement: Element, hooksConfig?: any): Promise<void>;
    copilotbrowserUnmount(rootElement: Element): Promise<void>;
    copilotbrowserUpdate(rootElement: Element, component: Component): Promise<void>;
