...
import { declare, traverse, types } from 'copilotbrowser/lib/transform/babelBundle';
import { setTransformData } from 'copilotbrowser/lib/transform/transform';

import type { BabelAPI, PluginObj, T } from 'copilotbrowser/lib/transform/babelBundle';
