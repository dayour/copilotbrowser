...
import { getUserData } from 'copilotbrowser/lib/transform/compilationCache';
...
import type { copilotbrowserTestConfig as BasecopilotbrowserTestConfig } from 'copilotbrowser/types/test';
import type { FullConfig } from 'copilotbrowser/types/testReporter';
...
export function frameworkConfig(config: FullConfig): { registerSourceFile: string, frameworkPluginFactory?: () => Promise<Plugin> } {
  return (config as any)['@copilotbrowser/experimental-ct-core'];
}
