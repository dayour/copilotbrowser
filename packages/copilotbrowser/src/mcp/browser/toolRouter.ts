...
export type ResolveToolResult =
  | { found: true;  tool: Tool; decision: AllowDecision | RedirectDecision }
  | { found: false; decision: DenyDecision | AllowDecision };
 ...
 */
export const passthroughStrategy: ToolRoutingStrategy = {
  name: 'passthrough',
};
...
export class ToolRouter {
  ...
  private readonly _strategies: ToolRoutingStrategy[];
