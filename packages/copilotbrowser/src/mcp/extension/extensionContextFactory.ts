...
export class ExtensionContextFactory implements BrowserContextFactory {
  ...
  private async _obtainBrowser(clientInfo: ClientInfo, abortSignal: AbortSignal, toolName: string | undefined): Promise<copilotbrowser.Browser> {
    ...
    return await copilotbrowser.chromium.connectOverCDP(relay.cdpEndpoint(), { isLocal: true });
  }
