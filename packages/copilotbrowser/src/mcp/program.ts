...
export function decorateMCPCommand(command: Command, version: string) {
  command
      ...
      .option('--extension', 'Connect to a running browser instance (Edge/Chrome only). Requires the "copilotbrowser MCP Bridge" browser extension to be installed.')
      ...
      .option('--init-page <path...>', 'path to TypeScript file to evaluate on copilotbrowser page object')
      ...
      .option('--save-session', 'Whether to save the copilotbrowser MCP session into the output directory.')
      .option('--save-trace', 'Whether to save the copilotbrowser Trace of the session into the output directory.')
      ...
      .action(async options => {
        ...
        if (config.extension) {
          const serverBackendFactory: mcpServer.ServerBackendFactory = {
            name: 'copilotbrowser w/ extension',
            nameInConfig: 'copilotbrowser-extension',
            version,
