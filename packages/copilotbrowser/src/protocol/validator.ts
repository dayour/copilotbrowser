...
scheme.RootInitializeResult = tObject({
  copilotbrowser: tChannel(['copilotbrowser']),
});
scheme.copilotbrowserInitializer = tObject({
...
scheme.copilotbrowserNewRequestParams = tObject({
  baseURL: tOptional(tString),
...
scheme.copilotbrowserNewRequestResult = tObject({
