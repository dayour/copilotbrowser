...
class Root extends ChannelOwner<channels.RootChannel> {
  ...
  async initialize(): Promise<copilotbrowser> {
    return copilotbrowser.from((await this._channel.initialize({
...
export class Connection extends EventEmitter {
  ...
  // Used from @copilotbrowser/copilotbrowser fixtures -> TODO remove?
  ...
  async initializecopilotbrowser(): Promise<copilotbrowser> {
  ...
  private _createRemoteObject(parentGuid: string, type: string, guid: string, initializer: any): any {
    ...
    switch (type) {
      ...
      case 'PageAgent':
        ...
        break;
      case 'copilotbrowser':
        result = new copilotbrowser(parent, type, guid, initializer);
        break;
      case 'Request':
