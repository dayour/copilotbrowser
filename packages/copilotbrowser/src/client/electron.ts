...
export class Electron extends ChannelOwner<channels.ElectronChannel> {
  ...
  async launch(options: ElectronOptions = {}): Promise<ElectronApplication> {
    ...
    app.once(Events.ElectronApplication.Close, () => this._copilotbrowser.selectors._contextsForSelectors.delete(app._context));
