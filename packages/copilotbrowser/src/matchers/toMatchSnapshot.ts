...
export async function toHaveScreenshot(
  ...
  const [page, locator] = pageOrLocator.constructor.name === 'Page' ? [(pageOrLocator as unknown as PageEx), undefined] : [(pageOrLocator as Locator).page() as unknown as PageEx, pageOrLocator as Locator];
