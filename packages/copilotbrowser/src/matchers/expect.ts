...
// Expect wraps matchers, so there is no way to pass this information to the raw copilotbrowser matcher.
...
function wrapcopilotbrowserMatcherToPassNiceThis(matcher: any) {
