...
/**
 * @param {any} type
 * @returns {boolean} type is copilotbrowser's mock JSX.Fragment
 */
...
/**
 * Turns the copilotbrowser representation of JSX (see jsx-runtime.js) into React.createElement calls.
 * @param {any} value
 */
