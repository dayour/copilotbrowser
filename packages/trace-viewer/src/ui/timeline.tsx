...
export const Timeline: React.FunctionComponent<{
  ...
  const activeBars = React.useMemo(() => {
    return bars.map(bar => ({
      ...bar,
      active: highlightedAction
        ? bar.action === highlightedAction
        : highlightedResourceOrdinal !== undefined
          ? bar.resource === networkResources?.[highlightedResourceOrdinal]
          : highlightedConsoleEntryOrdinal !== undefined
            ? bar.consoleMessage === consoleEntries?.[highlightedConsoleEntryOrdinal]
            : false,
    }));
