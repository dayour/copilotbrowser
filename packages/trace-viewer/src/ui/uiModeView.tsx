...
import type * as reporterTypes from 'copilotbrowser/types/testReporter';
...
function escapeRegex(text: string) {
  // copilotbrowser interprets absolute paths as regex,
...
export const UIModeView: React.FC<{}> = ({
  ...
  return <div className='vbox ui-mode'>
    {!hasBrowsers && <dialog ref={dialogRef}>
      ...
      <div className='body'>
        copilotbrowser did not find installed browsers.
        <br></br>
        Would you like to run `copilotbrowser install`?
        <br></br>
    ...
    <SplitView
      ...
      sidebar={<div className='vbox ui-mode-sidebar'>
        <Toolbar noShadow={true} noMinHeight={true}>
          ...
          <div className='section-title'>copilotbrowser</div>
          ...
          {!hasBrowsers && <ToolbarButton icon='lightbulb-autofix' style={{ color: 'var(--vscode-list-warningForeground)' }} title='copilotbrowser browsers are missing' onClick={openInstallDialog} />}
        </Toolbar>
        <FiltersView
