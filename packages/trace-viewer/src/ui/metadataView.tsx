...
export const MetadataView: React.FunctionComponent<{
  ...
  return <div style={{ flex: 'auto', display: 'block', overflow: 'hidden auto' }}>
    ...
    {model.copilotbrowserVersion && <div className='call-line'>copilotbrowser version:<span className='call-value string' title={model.copilotbrowserVersion}>{model.copilotbrowserVersion}</span></div>}
