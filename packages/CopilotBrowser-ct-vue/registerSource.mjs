...
/** @typedef {import('../copilotbrowser-ct-core/types/component').Component} Component */
/** @typedef {import('../copilotbrowser-ct-core/types/component').JsxComponent} JsxComponent */
/** @typedef {import('../copilotbrowser-ct-core/types/component').ObjectComponent} ObjectComponent */
...
window.copilotbrowserMount = async (component, rootElement, hooksConfig) => {
...
window.copilotbrowserUnmount = async rootElement => {
...
window.copilotbrowserUpdate = async (rootElement, component) => {
