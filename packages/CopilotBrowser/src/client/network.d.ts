...
export declare class Request extends ChannelOwner<channels.RequestChannel> {
...
export declare class Route extends ChannelOwner<channels.RouteChannel> {
...
export declare class Response extends ChannelOwner<channels.ResponseChannel> {
    private _provisionalHeaders;
    private _actualHeadersPromise;
    private _request;
...
export declare class WebSocket extends ChannelOwner<channels.WebSocketChannel> {
    private _page;
    private _isClosed;
