...
import { DEFAULT_copilotbrowser_LAUNCH_TIMEOUT, DEFAULT_copilotbrowser_TIMEOUT } from '../utils/isomorphic/time';
...
export class TimeoutSettings {
  ...
  navigationTimeout(options: { timeout?: number }): number {
    ...
    return DEFAULT_copilotbrowser_TIMEOUT;
  }
  ...
  launchTimeout(options: { timeout?: number }): number {
    ...
    return DEFAULT_copilotbrowser_LAUNCH_TIMEOUT;
  }
}
