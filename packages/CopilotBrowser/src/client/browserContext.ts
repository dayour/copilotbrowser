...
export async function toClientCertificatesProtocol(platform: Platform, certs?: BrowserContextOptions['clientCertificates']): Promise<channels.copilotbrowserNewRequestParams['clientCertificates']> {
  if (!certs)
    return undefined;
