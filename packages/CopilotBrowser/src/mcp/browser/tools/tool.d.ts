...
export type FileUploadModalState = {
    type: 'fileChooser';
    description: string;
    fileChooser: copilotbrowser.FileChooser;
    clearedBy: {
        tool: string;
        skill: string;
    };
...
export declare function defineTool<Input extends z.Schema>(tool: Tool<Input>): Tool<Input>;
...
export declare function defineTabTool<Input extends z.Schema>(tool: TabTool<Input>): Tool<Input>;
