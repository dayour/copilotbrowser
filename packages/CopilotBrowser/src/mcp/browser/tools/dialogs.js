...
exports.handleDialog = (0, tool_1.defineTabTool)({
    ...
    schema: {
        ...
        inputSchema: mcpBundle_1.z.object({
            accept: mcpBundle_1.z.boolean().describe('Whether to accept the dialog.'),
            promptText: mcpBundle_1.z.string().optional().describe('The text of the prompt in case of a prompt dialog.'),
        }),
        type: 'action',
    },
