...
export const runTests = defineTestTool({
  schema: {
    ...
    inputSchema: z.object({
      ...
      projects: z.array(z.string()).optional().describe('Projects to run, projects from copilotbrowser.config.ts, by default runs all projects. Running with "chromium" is a good start'),
    }),
    type: 'readOnly',
  },
