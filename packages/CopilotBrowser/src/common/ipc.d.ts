...
export type DonePayload = {
    ...
    skipTestsDueToSetupFailure: string[];
...
export declare function serializeConfig(config: FullConfigInternal, passCompilationCache: boolean): SerializedConfig;
export declare function stdioChunkToParams(chunk: Uint8Array | string): TestOutputPayload;
