    ...
    switch (event.type) {
      case 'context-options': {
        if (event.version > latestVersion)
          throw new TraceVersionError('The trace was created by a newer version of copilotbrowser and is not supported by this version of the viewer. Please use latest copilotbrowser to open the trace.');
        ...
        contextEntry.copilotbrowserVersion = event.copilotbrowserVersion;
