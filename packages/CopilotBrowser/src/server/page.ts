...
export class Page extends SdkObject<PageEventMap> {
  ...
  async exposeBinding(progress: Progress, name: string, needsHandle: boolean, copilotbrowserBinding: frames.FunctionWithSource): Promise<PageBinding> {
...
export class PageBinding {
  private static kController = '__copilotbrowser__binding__controller__';
