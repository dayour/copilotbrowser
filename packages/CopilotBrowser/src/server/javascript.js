...
const rawUtilityScriptSource = __importStar(require("../generated/utilityScriptSource"));
...
class ExecutionContext extends instrumentation_1.SdkObject {
    delegate;
    _utilityScriptPromise;
    _contextDestroyedScope = new manualPromise_1.LongStandingScope();
    worldNameForTest;
    ...
    utilityScript() {
      ...
      (() => {
        ...
        return new (module.exports.UtilityScript())(globalThis, ${(0, utils_1.isUnderTest)()});
      })();`;
...
async function evaluateExpression(context, expression, options, ...args) {
    ...
    args = args.map(arg => (0, utilityScriptSerializers_1.serializeAsCallArgument)(arg, handle => {
