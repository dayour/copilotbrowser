...
export class copilotbrowser extends SdkObject {
  ...
  constructor(options: copilotbrowserOptions) {
    ...
    this.attribution.copilotbrowser = this as copilotbrowser;
    ...
    this.electron = new Electron(this as copilotbrowser);
    this.android = new Android(this, new AdbBackend());
    this.debugController = new DebugController(this as copilotbrowser);
  }
...
export function createcopilotbrowser(options: copilotbrowserOptions) {
