...
exports.deserializeBidiValue = deserializeBidiValue;
const javascript_1 = require("../javascript");
function deserializeBidiValue(result, internalIdMap = new Map()) {
    switch (result.type) {
        case 'undefined':
            return undefined;
        case 'null':
            return null;
        case 'number':
            return typeof result.value === 'number' ? result.value : (0, javascript_1.parseUnserializableValue)(result.value);
        case 'boolean':
