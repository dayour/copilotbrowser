...
(default: 0).
  ...
  export namespace copilotbrowser {
    /**
    ...
    export type createContextParameters = {
      ...
      /**
       * Wether to use storage partitioning. Be default copilotbrowser disables the partitioning.
       */
  ...
  export type Events = {
    ...
    "copilotbrowser.pageProxyCreated": copilotbrowser.pageProxyCreatedPayload;
    "copilotbrowser.pageProxyDestroyed": copilotbrowser.pageProxyDestroyedPayload;
    "copilotbrowser.provisionalLoadFailed": copilotbrowser.provisionalLoadFailedPayload;
    "copilotbrowser.windowOpen": copilotbrowser.windowOpenPayload;
    "copilotbrowser.downloadCreated": copilotbrowser.downloadCreatedPayload;
    "copilotbrowser.downloadFilenameSuggested": copilotbrowser.downloadFilenameSuggestedPayload;
    "copilotbrowser.downloadFinished": copilotbrowser.downloadFinishedPayload;
  ...
  export interface CommandParameters {
    ...
    "copilotbrowser.enable": copilotbrowser.enableParameters;
    "copilotbrowser.disable": copilotbrowser.disableParameters;
    "copilotbrowser.getInfo": copilotbrowser.getInfoParameters;
    "copilotbrowser.close": copilotbrowser.closeParameters;
    "copilotbrowser.createContext": copilotbrowser.createContextParameters;
    "copilotbrowser.deleteContext": copilotbrowser.deleteContextParameters;
    "copilotbrowser.createPage": copilotbrowser.createPageParameters;
    "copilotbrowser.navigate": copilotbrowser.navigateParameters;
    "copilotbrowser.grantFileReadAccess": copilotbrowser.grantFileReadAccessParameters;
    "copilotbrowser.takePageScreenshot": copilotbrowser.takePageScreenshotParameters;
    "copilotbrowser.setIgnoreCertificateErrors": copilotbrowser.setIgnoreCertificateErrorsParameters;
    "copilotbrowser.setPageZoomFactor": copilotbrowser.setPageZoomFactorParameters;
    "copilotbrowser.getAllCookies": copilotbrowser.getAllCookiesParameters;
    "copilotbrowser.setCookies": copilotbrowser.setCookiesParameters;
    "copilotbrowser.deleteAllCookies": copilotbrowser.deleteAllCookiesParameters;
    "copilotbrowser.setGeolocationOverride": copilotbrowser.setGeolocationOverrideParameters;
    "copilotbrowser.setLanguages": copilotbrowser.setLanguagesParameters;
    "copilotbrowser.setDownloadBehavior": copilotbrowser.setDownloadBehaviorParameters;
    "copilotbrowser.cancelDownload": copilotbrowser.cancelDownloadParameters;
    "copilotbrowser.clearMemoryCache": copilotbrowser.clearMemoryCacheParameters;
  ...
  export interface CommandReturnValues {
    ...
    "copilotbrowser.enable": copilotbrowser.enableReturnValue;
    "copilotbrowser.disable": copilotbrowser.disableReturnValue;
    "copilotbrowser.getInfo": copilotbrowser.getInfoReturnValue;
    "copilotbrowser.close": copilotbrowser.closeReturnValue;
    "copilotbrowser.createContext": copilotbrowser.createContextReturnValue;
    "copilotbrowser.deleteContext": copilotbrowser.deleteContextReturnValue;
    "copilotbrowser.createPage": copilotbrowser.createPageReturnValue;
    "copilotbrowser.navigate": copilotbrowser.navigateReturnValue;
    "copilotbrowser.grantFileReadAccess": copilotbrowser.grantFileReadAccessReturnValue;
    "copilotbrowser.takePageScreenshot": copilotbrowser.takePageScreenshotReturnValue;
    "copilotbrowser.setIgnoreCertificateErrors": copilotbrowser.setIgnoreCertificateErrorsReturnValue;
    "copilotbrowser.setPageZoomFactor": copilotbrowser.setPageZoomFactorReturnValue;
    "copilotbrowser.getAllCookies": copilotbrowser.getAllCookiesReturnValue;
    "copilotbrowser.setCookies": copilotbrowser.setCookiesReturnValue;
    "copilotbrowser.deleteAllCookies": copilotbrowser.deleteAllCookiesReturnValue;
    "copilotbrowser.setGeolocationOverride": copilotbrowser.setGeolocationOverrideReturnValue;
    "copilotbrowser.setLanguages": copilotbrowser.setLanguagesReturnValue;
    "copilotbrowser.setDownloadBehavior": copilotbrowser.setDownloadBehaviorReturnValue;
    "copilotbrowser.cancelDownload": copilotbrowser.cancelDownloadReturnValue;
    "copilotbrowser.clearMemoryCache": copilotbrowser.clearMemoryCacheReturnValue;
