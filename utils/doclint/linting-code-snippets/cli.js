...
class JSLintingService extends LintingService {
  ...
  async _init() {
    ...
    const baseConfig = [
      ...
      {
        plugins: { '@typescript-eslint': typescriptEslint.default || typescriptEslint },
        rules: Object.fromEntries(
          Object.entries((typescriptEslint.default || typescriptEslint).configs?.['disable-type-checked']?.rules || {})
        ),
      },
    ];
