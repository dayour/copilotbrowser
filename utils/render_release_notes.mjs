...
import { rendercopilotbrowserDevLinks, docsLinkRendererForLanguage, languageToRelativeDocsPath } from './doclint/linkUtils.js';
...
const output = rendercopilotbrowserDevLinks(md.render(nodes), languageToRelativeDocsPath(language), '', true);
