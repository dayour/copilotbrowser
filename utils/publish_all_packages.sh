...
function cleanup {
  ...
  if [[ ! -z "${copilotbrowser_TGZ}" ]]; then rm -rf "${copilotbrowser_TGZ}"; fi
  if [[ ! -z "${copilotbrowser_CORE_TGZ}" ]]; then rm -rf "${copilotbrowser_CORE_TGZ}"; fi
  if [[ ! -z "${copilotbrowser_WEBKIT_TGZ}" ]]; then rm -rf "${copilotbrowser_WEBKIT_TGZ}"; fi
  if [[ ! -z "${copilotbrowser_FIREFOX_TGZ}" ]]; then rm -rf "${copilotbrowser_FIREFOX_TGZ}"; fi
  if [[ ! -z "${copilotbrowser_CHROMIUM_TGZ}" ]]; then rm -rf "${copilotbrowser_CHROMIUM_TGZ}"; fi
}
