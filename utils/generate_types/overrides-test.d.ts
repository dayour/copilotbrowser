...
export interface FullProject<TestArgs = {}, WorkerArgs = {}> {
  use: UseOptions<copilotbrowserTestOptions & TestArgs, copilotbrowserWorkerOptions & WorkerArgs>;
}
...
export interface copilotbrowserWorkerOptions {
...
export interface copilotbrowserTestOptions {
...
export interface copilotbrowserTestArgs {
...
type CustomProperties<T> = ExcludeProps<T, copilotbrowserTestOptions & copilotbrowserWorkerOptions & copilotbrowserTestArgs & copilotbrowserWorkerArgs>;

export type copilotbrowserTestProject<TestArgs = {}, WorkerArgs = {}> = Project<copilotbrowserTestOptions & CustomProperties<TestArgs>, copilotbrowserWorkerOptions & CustomProperties<WorkerArgs>>;
export type copilotbrowserTestConfig<TestArgs = {}, WorkerArgs = {}> = Config<copilotbrowserTestOptions & CustomProperties<TestArgs>, copilotbrowserWorkerOptions & CustomProperties<WorkerArgs>>;
...
type BaseMatchers<R, T> = GenericAssertions<R> & copilotbrowserTest.Matchers<R, T> & SnapshotAssertions;
type AllowedGenericMatchers<R, T> = copilotbrowserTest.Matchers<R, T> & Pick<GenericAssertions<R>, 'toBe' | 'toBeDefined' | 'toBeFalsy' | 'toBeNull' | 'toBeTruthy' | 'toBeUndefined'>;
...
// --- BEGINGLOBAL ---
declare global {
  export namespace copilotbrowserTest {
...
/**
 * These tests are executed in copilotbrowser environment that launches the browser
 * and provides a fresh page to each test.
 */
export const test: TestType<copilotbrowserTestArgs & copilotbrowserTestOptions, copilotbrowserWorkerArgs & copilotbrowserWorkerOptions>;
export default test;
