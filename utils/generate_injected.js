...
const injectedScripts = [
  [
    ...
    path.join(ROOT, 'packages', 'copilotbrowser', 'src', 'generated'),
    true,
  ],
  [
  ...
  [
    path.join(ROOT, 'packages', 'copilotbrowser', 'src', 'ct', 'injected', 'index.ts'),
    path.join(ROOT, 'packages', 'copilotbrowser', 'lib', 'ct', 'injected', 'packed'),
    path.join(ROOT, 'packages', 'copilotbrowser', 'src', 'ct', 'generated'),
    false,
  ]
];
