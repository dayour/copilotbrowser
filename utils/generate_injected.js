...
const injectedScripts = [
  [
    ...
    path.join(ROOT, 'packages', 'copilotbrowser-core', 'src', 'generated'),
    true,
  ],
  [
  ...
  [
    path.join(ROOT, 'packages', 'copilotbrowser-ct-core', 'src', 'injected', 'index.ts'),
    path.join(ROOT, 'packages', 'copilotbrowser-ct-core', 'lib', 'injected', 'packed'),
    path.join(ROOT, 'packages', 'copilotbrowser-ct-core', 'src', 'generated'),
    false,
  ]
];
...
async function replaceEsbuildHeader(content, outFileJs) {
  ...
  // See https://github.com/dayour/copilotbrowser/issues/17029
