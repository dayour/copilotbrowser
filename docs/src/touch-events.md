...
public class TouchEvents
{
    public static async Task Main(string[] args)
    {
        ...
        var context = await browser.NewContextAsync(copilotbrowser.Devices["Pixel 7"]);
...
```python sync
from copilotbrowser.sync_api import sync_copilotbrowser, expect
...
```python async
from copilotbrowser.async_api import async_copilotbrowser, expect
