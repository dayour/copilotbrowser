---
id: trace-viewer-intro-js
title: "Trace viewer"
sidebar_label: "Trace viewer (JavaScript)"
---
...
copilotbrowser Trace Viewer is a GUI tool that lets you explore recorded copilotbrowser traces of your tests, meaning you can go back and forward through each action of your test and visually see what was happening during each action.
...
![copilotbrowser html report](./images/getting-started/html-report-failed-tests.png)
...
![copilotbrowser html report detailed view](./images/getting-started/html-report-trace.png)
