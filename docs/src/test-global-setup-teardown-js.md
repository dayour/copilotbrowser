...
| copilotbrowser fixtures              | ✅ Fully supported                  | ❌ Not supported                   |
...
- our blog post [A better global setup in copilotbrowser reusing login with project dependencies](https://dev.to/copilotbrowser/a-better-global-setup-in-copilotbrowser-reusing-login-with-project-dependencies-14)
