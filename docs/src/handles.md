...
copilotbrowser can create handles to the page DOM elements or any other objects inside the
page. These handles live in the copilotbrowser process, whereas the actual objects live
...
and returns a handle to this array into copilotbrowser. It then uses the handle
