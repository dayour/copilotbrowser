...
[Dockerfile.noble] can be used to run copilotbrowser scripts in Docker environment. This image includes the [copilotbrowser browsers](./browsers.md#install-browsers) and [browser system dependencies](./browsers.md#install-system-dependencies). The copilotbrowser package/dependency is not included in the image and should be installed separately.
...
[`seccomp_profile.json`](https://github.com/dayour/copilotbrowser/blob/main/utils/docker/seccomp_profile.json) is needed to run Chromium with sandbox. This is a [default Docker seccomp profile](https://github.com/docker/engine/blob/d0d99b04cf6e00ed3fc27e81fc3d94e7eda70af3/profiles/seccomp/default.json) with extra user namespace cloning permissions:
...
To run copilotbrowser inside Docker, you need to have Node.js, [copilotbrowser browsers](./browsers.md#install-browsers) and [browser system dependencies](./browsers.md#install-system-dependencies) installed. See the following Dockerfile:
...
To run copilotbrowser inside Docker, you need to have Python, [copilotbrowser browsers](./browsers.md#install-browsers) and [browser system dependencies](./browsers.md#install-system-dependencies) installed. See the following Dockerfile:
