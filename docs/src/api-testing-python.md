...
title: "API testing"
sidebar_label: "API testing (Python)"
---
...
The following examples rely on the [`pytest-copilotbrowser`](./test-runners.md) package which add copilotbrowser fixtures to the Pytest test-runner.
...
import pytest
from copilotbrowser.sync_api import copilotbrowser, APIRequestContext
...
def api_request_context(
    ...
    request_context = copilotbrowser.request.new_context(
...
import pytest
from copilotbrowser.sync_api import copilotbrowser, Page, APIRequestContext, expect
...
```python
request_context = copilotbrowser.request.new_context(http_credentials={"username": "test", "password": "test"})
