...
copilotbrowser Trace Viewer is a GUI tool that helps you explore recorded copilotbrowser traces after the script has run. Traces are a great way for debugging your tests when they fail on CI. You can open traces [locally](#opening-the-trace) or in your browser on [trace.copilotbrowser.dev](https://trace.copilotbrowser.dev).
...
You can open a saved trace using either the copilotbrowser CLI or in the browser at [trace.copilotbrowser.dev](https://trace.copilotbrowser.dev). Make sure to add the full path to where your `trace.zip` file is located.

```bash js
npx copilotbrowser show-trace path/to/trace.zip
```
...
```bash csharp
pwsh bin/Debug/netX/copilotbrowser.ps1 show-trace trace.zip
```

### Using [trace.copilotbrowser.dev](https://trace.copilotbrowser.dev)

[trace.copilotbrowser.dev](https://trace.copilotbrowser.dev) is a statically hosted variant of the Trace Viewer. You can upload a trace file using drag and drop or via the `Select file` button.

Trace Viewer loads the trace entirely in your browser and does not transmit any data externally.

<img width="1119" alt="Drop copilotbrowser Trace to load" src="https://user-images.githubusercontent.com/13063165/194577918-b4d45726-2692-4093-8a28-9e73552617ef.png" />
...
```bash js
npx copilotbrowser show-trace https://example.com/trace.zip
```

```bash java
mvn exec:java -e -D exec.mainClass=com.microsoft.copilotbrowser.CLI -D exec.args="show-trace https://example.com/trace.zip"
```

```bash python
copilotbrowser show-trace https://example.com/trace.zip
```

```bash csharp
pwsh bin/Debug/netX/copilotbrowser.ps1 show-trace https://example.com/trace.zip
```

When using [trace.copilotbrowser.dev](https://trace.copilotbrowser.dev), you can also pass the URL of your uploaded trace at some accessible storage (e.g. inside your CI) as a query parameter. CORS (Cross-Origin Resource Sharing) rules might apply.

```txt
https://trace.copilotbrowser.dev/?trace=https://demo.copilotbrowser.dev/reports/todomvc/data/e6099cadf79aa753d5500aa9508f9d1dbd87b5ee.zip
```
...
If you are not using copilotbrowser as a Test Runner, use the **BrowserContext.tracing** API instead.
...
public class Tests : PageTest
{
    ...
    public async Task TearDown()
    {
        ...
        // bin/Debug/net8.0/copilotbrowser-traces/copilotbrowserTests.Tests.Test1.zip
...
namespace copilotbrowserTestsMSTest;
...
public class UnitTest1 : PageTest
{
    ...
    {
        // This will produce e.g.:
        // bin/Debug/net8.0/copilotbrowser-traces/copilotbrowserTests.UnitTest1.zip
        await Context.Tracing.StopAsync(new()
        {
            Path = Path.Combine(
...
This will record the trace and place it into the `bin/Debug/net8.0/copilotbrowser-traces/` directory.
...
![actions tab in trace viewer](https://github.com/dayour/copilotbrowser/assets/13063165/948b65cd-f0fd-4c7f-8e53-2c632b5a07f1)
...
![timeline view in trace viewer](https://github.com/dayour/copilotbrowser/assets/13063165/b04a7d75-54bb-4ab2-9e30-e76f6f74a2c8)


### Snapshots

When tracing with the **Tracing.start.snapshots** option turned on (default), copilotbrowser captures a set of complete DOM snapshots for each action. Depending on the type of the action, it will capture:

| Type | Description |
|------|-------------|
|Before|A snapshot at the time action is called.|
|Action|A snapshot at the moment of the performed input. This type of snapshot is especially useful when exploring where exactly copilotbrowser clicked.|
|After|A snapshot after the action.|

Here is what the typical Action snapshot looks like:

![action tab in trace viewer](https://github.com/dayour/copilotbrowser/assets/13063165/7168d549-eb0a-4964-9c93-483f03711fa9)
...
![showing source code tab in trace viewer](https://github.com/dayour/copilotbrowser/assets/13063165/daa8845d-c250-4923-aa7a-5d040da9adc5)
...
![showing call tab in trace viewer](https://github.com/dayour/copilotbrowser/assets/13063165/95498580-f9dd-4932-a123-c37fe7cfc3c2)

### Log

See a full log of your test to better understand what copilotbrowser is doing behind the scenes such as scrolling into view, waiting for element to be visible, enabled and stable and performing actions such as click, fill, press etc.

![showing log of tests in trace viewer](https://github.com/dayour/copilotbrowser/assets/13063165/de621461-3bab-4140-b39d-9f02d6672dbf)
...
![showing errors in trace viewer](https://github.com/dayour/copilotbrowser/assets/13063165/e9ef77b3-05d1-4df2-852c-981023723d34)
...
![showing log of tests in trace viewer](https://github.com/dayour/copilotbrowser/assets/13063165/4107c08d-1eaf-421c-bdd4-9dd2aa641d4a)
...
![network requests tab in trace viewer](https://github.com/dayour/copilotbrowser/assets/13063165/0a3d1671-8ccd-4f7a-a844-35f5eb37f236)
...
![meta data in trace viewer](https://github.com/dayour/copilotbrowser/assets/13063165/82ab3d33-1ec9-4b8a-9cf2-30a6e2d59091)
...
![attachments tab in trace viewer](https://github.com/dayour/copilotbrowser/assets/13063165/4386178a-5808-4fa8-9436-315350a23b04)
