...
id: api-testing-java
title: "API testing"
sidebar_label: "API testing (Java)"
---
...
import com.microsoft.copilotbrowser.APIRequest;
import com.microsoft.copilotbrowser.APIRequestContext;
...
public class TestGitHubAPI {
  ...
  private copilotbrowser copilotbrowser;
  private APIRequestContext request;

  void createcopilotbrowser() {
  ...
  void createAPIRequestContext() {
    ...
    request = copilotbrowser.request().newContext(new APIRequest.NewContextOptions()
  ...
  void closecopilotbrowser() {
    if (copilotbrowser != null) {
...
import com.microsoft.copilotbrowser.APIRequest;
import com.microsoft.copilotbrowser.APIRequestContext;
import com.microsoft.copilotbrowser.APIResponse;
import com.microsoft.copilotbrowser.copilotbrowser;
import com.microsoft.copilotbrowser.options.RequestOptions;
import org.junit.jupiter.api.AfterAll;
import org.junit.jupiter.api.BeforeAll;
...
```java
APIRequestContext requestContext = copilotbrowser.request().newContext(
