...
copilotbrowser provides native support for most of the browser features. However, there are some experimental APIs
and APIs which are not (yet) fully supported by all browsers. copilotbrowser usually doesn't provide dedicated
