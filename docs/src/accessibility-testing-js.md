---
id: accessibility-testing-js
title: "Accessibility testing"
sidebar_label: "Accessibility testing (JavaScript)"
---
...
The following examples rely on the [`@axe-core/copilotbrowser`](https://npmjs.org/@axe-core/copilotbrowser) package which adds support for running the [axe accessibility testing engine](https://www.deque.com/axe/) as part of your copilotbrowser tests.
...
1. Imports the `@axe-core/copilotbrowser` package
1. Uses normal copilotbrowser Test syntax to define a test case
1. Uses normal copilotbrowser syntax to navigate to the page under test
...
`@axe-core/copilotbrowser` supports many configuration options for axe. You can specify these options by using a Builder pattern with the `AxeBuilder` class.

For example, you can use [`AxeBuilder.include()`](https://github.com/dequelabs/axe-core-npm/blob/develop/packages/copilotbrowser/README.md#axebuilderincludeselector-string--string) to constrain an accessibility scan to only run against one specific part of a page.
...
If your application contains a few specific elements with known issues, you can use [`AxeBuilder.exclude()`](https://github.com/dequelabs/axe-core-npm/blob/develop/packages/copilotbrowser/README.md#axebuilderexcludeselector-string--string) to exclude them from being scanned until you're able to fix the issues.
...
If your application contains many different preexisting violations of a specific rule, you can use [`AxeBuilder.disableRules()`](https://github.com/dequelabs/axe-core-npm/blob/develop/packages/copilotbrowser/README.md#axebuilderdisablerulesrules-stringarray) to temporarily disable individual rules until you're able to fix the issues.
