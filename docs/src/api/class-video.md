...
Saves the video to a user-specified path. This must be called after **Page.close()** (or **BrowserContext.close()**), otherwise an error will be thrown. This method waits until the video is fully saved.
