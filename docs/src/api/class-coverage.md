...
on the page using `eval` or `new Function`. If **reportAnonymousScripts** is set to `true`, anonymous scripts
will have `__copilotbrowser_evaluation_script__` as their URL.
:::
