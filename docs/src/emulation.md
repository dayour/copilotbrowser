...
async def run(copilotbrowser: copilotbrowser):
    iphone_13 = copilotbrowser.devices['iPhone 13']
    browser = await copilotbrowser.webkit.launch(headless=False)
...
def run(copilotbrowser: copilotbrowser):
    iphone_13 = copilotbrowser.devices['iPhone 13']
    browser = copilotbrowser.webkit.launch(headless=False)
...
var iphone13 = copilotbrowser.Devices["iPhone 13"];
await using var context = await browser.NewContextAsync(iphone13);
```


<img width="458" alt="copilotbrowser.dev website emulated for iPhone 13" src="https://user-images.githubusercontent.com/13063165/220411073-76fe59f9-9a2d-463d-8e30-c19a7deca133.png" />


## Devices

copilotbrowser can emulate various devices by specifying `setDeviceScaleFactor`, `setHasTouch`, `setIsMobile`, `setScreenSize`, `setUserAgent` and `setViewportSize` options when creating a context with **Browser.newContext()**.
...
<img width="1394" alt="copilotbrowser web in dark mode" src="https://user-images.githubusercontent.com/13063165/220411638-55d2b051-4678-4da7-9f0b-ed22f5a3c47c.png" />
## User Agent
