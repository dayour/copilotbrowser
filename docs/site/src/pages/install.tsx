...
const methods = [
  ...
  { Icon: IcoCode2,   title: 'VS Code Extension',        subtitle: 'Run and debug tests inside VS Code',             commands: ['ext install ms-copilotbrowser.copilotbrowser'],                                 link: '/docs/getting-started-vscode-js' },
