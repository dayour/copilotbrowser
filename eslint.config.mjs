...
import originalNotice from "eslint-plugin-notice";
...
const notice = fixupPluginRules(originalNotice);
const fixedReact = fixupPluginRules(react);
const fixedImport = fixupPluginRules(importRules);
...
const ignores = [
  ...
  "node_modules/",
  "output/",
  "**/copilotbrowser-report/",
  "examples",
  "packages/*/lib/",
  "packages/copilotbrowser/bundles/zip/src/third_party/",
  "packages/copilotbrowser/bundles/zip/src/third_party/",
  "packages/copilotbrowser/src/generated/*",
  "packages/copilotbrowser/src/generated/*",
  "packages/copilotbrowser/src/third_party/",
  "packages/copilotbrowser/src/third_party/",
  "packages/copilotbrowser/types/*",
  "packages/copilotbrowser/types/*",
  "packages/copilotbrowser/src/ct/generated/*",
  "packages/copilotbrowser/src/ct/generated/*",
...
export default [
  ...
  {
    // Ensure rule names referenced by inline eslint-disable comments in JS files
    // resolve correctly under flat config.
    files: ["**/*.js", "**/*.mjs", "**/*.cjs"],
    plugins,
  },
  {
  ...
  {
    files: ["packages/copilotbrowser/**/*.ts"],
    rules: {
  ...
  {
    files: [
      "packages/copilotbrowser/src/utils/**/*.ts",
      "packages/copilotbrowser/src/utils/**/*.ts",
    ],
    languageOptions: languageOptionsWithTsConfig,
    rules: {
  ...
  {
    files: [
      "packages/copilotbrowser/src/client/**/*.ts",
      "packages/copilotbrowser/src/protocol/**/*.ts",
      "packages/copilotbrowser/src/client/**/*.ts",
      "packages/copilotbrowser/src/protocol/**/*.ts",
    ],
    languageOptions: languageOptionsWithTsConfig,
