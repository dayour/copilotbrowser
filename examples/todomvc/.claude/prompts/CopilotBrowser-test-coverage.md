...
1. Call #copilotbrowser-test-planner subagent with prompt:
...
2. For each test case from the test plan file (1.1, 1.2, ...), one after another, not in parallel, call #copilotbrowser-test-generator subagent with prompt:
...
3. Call #copilotbrowser-test-healer subagent with prompt:
